            ...
            <div class="col-md-12 col-xl-5">
                <div class="team-one-left_col">
                    <div class="pbmit-heading-subheading">
                        ...
                        <h2 class="pbmit-title">Meet Our Expert Logistics Team</h2>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="pbmit-spinner pbmit-spinner-box-style-1">
                    <a class="pbmit-lightbox-video" href="{{ route('our-team') }}">
                            ...
                            <div class="pbminfotech-post-item">
                                <div class="pbmit-featured-img-wrapper">
                                    <div class="pbmit-featured-wrapper">
                                        <img src="{{ asset('website/images/upload/atta-ullah-khan.png') }}"
                                            class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="pbminfotech-box-content">
                                    ...
                                    <div class="pbmit-titlebox">
                                        <div class="pbminfotech-box-team-position">Chairman</div>
                                        <h3 class="pbmit-team-title">
                                            <a href="#">Atta Ullah Khan</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <article class="pbmit-team-style-1">
                            <div class="pbminfotech-post-item">
                                <div class="pbmit-featured-img-wrapper">
                                    <div class="pbmit-featured-wrapper">
                                        <img src="{{ asset('website/images/upload/aslam.png') }}"
                                            class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="pbminfotech-box-content">
                                    ...
                                    <div class="pbmit-titlebox">
                                        <div class="pbminfotech-box-team-position">Sales Manager</div>
                                        <h3 class="pbmit-team-title">
                                            <a href="#">Aslam Mohammed</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
